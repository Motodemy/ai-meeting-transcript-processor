# AI Meeting Transcript Processor v0.2
...
**Language Note:** The system prompt and generated markers are configured for Polish-language meeting transcripts ([BRAK OSOBY], [BRAK TERMINU], [MIĘKKI TERMIN], [DO WERYFIKACJI], [ZMIANA USTALENIA], [SPRZECZNOŚĆ]).
...
* **Explicit Ambiguity Tracking:**
  ...
  * Soft/Relative Deadline -> [MIĘKKI TERMIN]
